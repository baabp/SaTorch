...
from src.datasets.utils import default_loader, image_loader, random_split
import src.transforms.transforms_cls as T_cls
...
def main():
    ...
    dataset = ImageFolder(datadir, train_transform=train_transform)
    # Divide to subset
